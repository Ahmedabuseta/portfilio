                            ...
                            ({ isVisible }) => (
                                <div className={`${isVisible && 'animate__animated animate__fadeIn'}`} >
                                    ...
                                    <p className='text-secondary  fs-6 text-start p-1  lh-sm fw-bold'>
                                        I am Ahmed Ahmed Abusetta undergradauted student in facaulty of engineering computers and control department in Tanta university , and i am a front end devolper with 
